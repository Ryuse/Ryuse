...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p>AI VTuber assistant for Twitch with chat responses, voice, and subtitles.</p>
      <p>
        <kbd>LLM Dialogue</kbd> <kbd>Voice</kbd> <kbd>Subtitles</kbd> <kbd>PPO RL</kbd>
      </p>
      <ul>
        <li>LLM-driven dialogue</li>
        <li>Real-time speech + subtitles synthesis</li>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Peer-to-peer coding interview practice platform with real-time collaboration.</p>
      <p>
        <kbd>Spring Boot</kbd> <kbd>ExpressJs</kbd> <kbd>Redis</kbd> <kbd>React</kbd> <kbd>Microservices</kbd> <kbd>Microfrontend</kbd>
      </p>
      <ul>
        <li>Real-time user matching</li>
        <li>Real-time coding collaboration</li>
